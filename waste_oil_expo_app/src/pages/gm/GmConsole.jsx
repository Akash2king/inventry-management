...
export function GmConsole() {
  ...
  return (
    <div>
      ...
      <details className="gm-console-help">
        <summary>Quick usage guide</summary>
        <p>
          Start with <strong>Departments</strong>, then create users in <strong>Users &amp; hierarchy</strong>. Use
          <strong> Overview &amp; reports</strong> for periodic exports only when needed.
        </p>
      </details>
      ...
      {gmTab === "overview" ? (
        ...
        <summary style={{ cursor: "pointer", fontWeight: 700, color: "var(--clr-text-bright)" }}>
