  ...
  return (
    <div className="record-detail-page">
      <div className="record-detail-topbar">
        <h2 className="record-detail-topbar__title">{r.record_number}</h2>
      ...
      <div className="record-workflow-wrap">
      ...
      <div className="card record-detail-card" style={{ marginTop: "1rem" }}>
        ...
        {canSeeHoldingTimeline && Array.isArray(r.holder_time_log) && r.holder_time_log.length > 0 ? (
          <Section title="Holding timeline (automatic)">
            <details className="record-detail-disclosure">
              <summary>Show holder timeline details</summary>
      ...
      <div className="record-mobile-actions">
        ...
        {showEdit ? (
          <button type="button" className="btn btn-ghost" onClick={() => navigate(`/records/${id}/edit`)}>
            Edit
          </button>
        ) : null}
        {showRet ? (
