...
export function ExecutiveDashboard() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setShowHeavySections(true), 160);
    return () => clearTimeout(timer);
  }, []);
  ...
  return (
    <div className="dashboard-page">
              ...
              >
                {topVendors.map((v) => (
                  <span
                    ...
                    className="btn btn-ghost"
                    style={{ fontSize: "0.72rem", padding: "0.25rem 0.5rem", cursor: "default" }}
                  >
      ...
      <div className="dashboard-layout-grid--tertiary">
        ...
        <div className="card" style={{ marginTop: "1rem", marginBottom: "1rem", opacity: 0.8 }}>
