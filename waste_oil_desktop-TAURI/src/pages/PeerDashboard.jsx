    ...
    <div className="dashboard-page">
      ...
      <div className="card dashboard-toolbar" style={{ marginBottom: "1rem", padding: "0.85rem 1rem" }}>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", alignItems: "center" }}>
          ...
          />
          <button type="button" className="btn btn-ghost" onClick={clearFilters} style={{ padding: "0.35rem 0.7rem", marginLeft: "0.35rem" }}>
            Reset
          </button>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.35rem", alignItems: "center", marginLeft: "0.5rem" }}>
            <span style={{ opacity: 0.75, fontSize: "0.8rem" }}>Alert:</span>
            {["green", "yellow", "orange", "red"].map((lv) => (
              <button
                key={lv}
                type="button"
                className="btn btn-ghost"
                onClick={() => setAlertFilter(alertFilter === lv ? null : lv)}
                style={{
                  padding: "0.3rem 0.55rem",
                  fontSize: "0.75rem",
                  border:
                    alertFilter === lv ? "1px solid #6ec8ff" : "1px solid var(--clr-border)",
