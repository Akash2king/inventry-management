...
/**
 * Build an .xlsx and trigger download via Blob (reliable in Electron; avoids SheetJS writeFile in webviews).
 *
 ...
 * @returns {Promise<boolean>} Always true when download is triggered
 */
